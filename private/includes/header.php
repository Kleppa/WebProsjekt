...
<nav class="navbar navbar-toggleable-sm fixed-top" id="custom-navbar">
    <div class="container">
        ...
        <a class="navbar-brand" href="<?php echo server_root(1) . '/'; ?>">
            <img src="<?php echo server_root(1) . '/img/wenture-logo@0.5x.png'; ?>" style="width: 70px">
            Wenture
        </a>
        <div id="navbar" class="navbar-collapse collapse">
            <div class="navbar-nav ml-auto">
                ...
                <a class="nav-item nav-link"
                   href="<?php echo server_root(1) . '/places.php?category=drink'; ?>">Drink</a>
                <a class="nav-item nav-link" href="<?php echo server_root(1) . '/places.php?category=food'; ?>">Eat</a>
